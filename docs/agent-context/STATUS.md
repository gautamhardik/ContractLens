...
- [ ] **Phase 5 & 6 — Contract Intelligence & Hybrid Extraction**: Structured entity, term, and clause extraction (parties, effective dates, payment terms, governing laws, termination windows) combining deterministic rules and targeted semantic inference. (NEXT)
